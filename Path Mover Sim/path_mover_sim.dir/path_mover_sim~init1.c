// path_mover_sim~init1.c
// AutoMod 12.6.1 Generated File
// Build: 12.6.1.12
// Model name:	path_mover_sim
// Model path:	C:\Users\Sakib92\OneDrive\Documents\Sem 5\IE3110\Project\Path Mover Sim\path_mover_sim.dir\
// Generated:	Sun Oct 04 17:09:02 2015
...
{
	am_model.$sys = model;
	am_model.am_Path_Mover.$sys = symGetSystemDataByName(am_model.$sys, "Path_Mover");
	am_model.am_Path_Mover.am_S1_0_6 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_6");
	am_model.am_Path_Mover.am_S1_0_4 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_4");
	am_model.am_Path_Mover.am_DefSegment = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "DefSegment");
	am_model.am_Path_Mover.am_S1_0_3 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_3");
	am_model.am_Path_Mover.am_S1_0_2 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_2");
	am_model.am_Path_Mover.am_S1_0_1 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_1");
	am_model.am_Path_Mover.am_Picker = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "Picker");
	am_model.am_Path_Mover.am_S1_0_10 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_0_10");
	am_model.am_Path_Mover.am_S1_2_20 = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "S1_2_20");
	am_model.am_Path_Mover.am_DefVehicle = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "DefVehicle");
	am_model.am_Path_Mover.am_parentsys = symGetSystemDataByName(am_model.am_Path_Mover.$sys, "parentsys");
